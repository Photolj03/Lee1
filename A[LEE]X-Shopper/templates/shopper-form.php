...
?>
<form class="alx-shopper-form" method="post" action="">
    <?php for ($i = 0; $i < $num; $i++): ?>
        <?php
        ...
        <div class="alx-shopper-dropdown">
            <label for="alx_dropdown_<?php echo $i; ?>"><strong><?php echo $title; ?></strong></label><br>
    ...
    <button type="submit" class="alx-shopper-search-btn view-product">Search</button>
